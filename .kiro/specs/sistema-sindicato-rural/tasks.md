...
- [ ] 3. Desenvolver módulo de gestão de sócios
  - [x] 3.1 Criar entidade Socio e SocioRepository
  ...
  - [x] 3.2 Implementar SocioService com regras de negócio
  ...
  - [x] 3.3 Criar SocioController com endpoints REST
...
- [ ] 5. Implementar sistema de pagamentos
  ...
  - [x] 5.2 Implementar PagamentoService com lógica de negócio
  ...
  - [x] 5.3 Criar PagamentoController com endpoints REST
...
- [ ] 6. Desenvolver sistema de geração de recibos
  - [x] 6.1 Implementar ReciboService para geração de PDFs
  ...
  - [x] 6.2 Integrar geração de recibos com pagamentos
...
- [ ] 7. Implementar sistema de gerenciamento de arquivos
  - [x] 7.1 Criar entidade Arquivo e ArquivoRepository
  ...
  - [x] 7.2 Implementar ArquivoService para upload e download
  ...
  - [x] 7.3 Criar ArquivoController com endpoints de arquivo
...
- [ ] 9. Desenvolver frontend Angular - Autenticação
  - [x] 9.1 Criar modelos TypeScript e interfaces
  ...
  - [x] 9.2 Implementar AuthService e interceptors
  ...
  - [x] 9.3 Criar componente de login
...
- [ ] 10. Desenvolver frontend Angular - Dashboard e navegação
  - [x] 10.1 Criar layout principal e navegação
  ...
  - [x] 10.2 Implementar componentes de listagem de sócios
  ...
  - [x] 10.3 Criar formulário de cadastro/edição de sócios
...
- [ ] 11. Desenvolver frontend Angular - Gestão de pagamentos
  - [x] 11.1 Criar componentes de listagem de pagamentos
    - Implementar PagamentoListComponent com filtros avançados
    - Configurar filtros por período, sócio e status
    - Implementar visualização de inadimplentes
    - _Requisitos: 3.3_

  - [x] 11.2 Implementar formulário de registro de pagamentos
  ...
  - [x] 11.3 Criar funcionalidades de recibos
...
- [ ] 12. Desenvolver frontend Angular - Gestão de arquivos
  - [x] 12.1 Implementar componente de upload de arquivos
  ...
  - [x] 12.2 Criar gerenciador de arquivos por sócio
...
- [ ] 13. Implementar tratamento de erros e performance
  - [x] 13.1 Configurar tratamento global de erros
  ...
  - [x] 13.2 Otimizar performance e responsividade
...
- [x] 15. Checkpoint final - Garantir que todos os testes passem
  - Garantir que todos os testes passem, perguntar ao usuário se surgem dúvidas.
